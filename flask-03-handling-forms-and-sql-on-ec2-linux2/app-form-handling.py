...
def greet():
    if 'user' in request.args:
        ...
        return render_template('greet.html', user='Send yoour usernmae with "user" param in query string')
