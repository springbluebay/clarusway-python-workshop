...
Purpose of the this hands-on training is to give the studentrs quick introductory knowledge of how to create a Flask web application on Amazon Linux 2 EC2 instance. 
